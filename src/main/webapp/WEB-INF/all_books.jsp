...
<c:if test="${not empty succMsg }">
	...
	<c:remove var="succMsgMsg" scope="session" />
	</c:if>
	...
	<table class="table table-striped">
		<thead class="bg-primary text-white">
			<tr>
				<th scope="col">ID</th>
				<th scope="col">Image</th><%@ page import="com.entity.BookDTLS" %>
<%@ page import="java.util.List" %>
<%@ page import="com.company.util.DBUtil" %>
<%@ page import="com.company.dao.BookDAOImpl" %>
...
<body>
    ...
    <div style="margin-top: 130px;">
		...
		<tbody>
			<%
			BookDao<%@page import="com.entity.BookDTLS"%>
			<%@page import="java.util.List"%>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
				            ...
				            <td><a href="edit_books.jsp" class="btn btn-sm btn-primary">Edit</a> 
...
Impl dao = new BookDaoimpl(DBConnect.getConn());
			List<BookDTLS> list = dao.getAllBooks();
			for (BookDTLS b : list) {
			%>
			<tr>
